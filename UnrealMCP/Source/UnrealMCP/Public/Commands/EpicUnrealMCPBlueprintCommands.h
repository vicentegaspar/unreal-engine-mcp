...
private:
    ...
    TSharedPtr<FJsonObject> HandleSetPhysicsMaterialProperties(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleSetCollisionProperties(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleSetBodyInstanceProperties(const TSharedPtr<FJsonObject>& Params);
